        ...
        {sent ? (
          ...
          <>
            <button
              ...
              disabled={loading}
              style={{ width: '100%', padding: '13px', marginBottom: 16, background: 'var(--glass)', border: '1px solid var(--glass-b)', borderRadius: 11, color: 'var(--txt)', fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 14, fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, transition: 'all .2s' }}
            >
              <GoogleIcon />
